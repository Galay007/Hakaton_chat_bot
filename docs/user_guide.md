...
- Максимум **10 файлов** за одну сессию. Бот напомнит об ограничении, если вы его достигнете.
- Размер файлов ограничен лимитами Telegram (до 2 Гб), поэтому больших архивов лучше разбивать заранее.
...
**A:** Нет, распакуйте экспорт и отправьте JSON/HTML.

**Q:** Что если нужно объединить более 10 файлов?  
**A:** Сформируйте новую сессию: `/export` или `/reset`, затем продолжайте загрузку следующих файлов.
