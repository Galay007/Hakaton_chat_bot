...
- Количество файлов не ограничено ботом. Telegram сам поделит файлы на сообщения, если отправлено более 10 файлов.
- Размер файлов ограничен лимитами в настройках бота (по умолчанию 10Мб). Это значение можно поменять 
