...
## Возможности
- Приём до 10 файлов экспорта чата и асинхронная обработка «на лету» без сохранения на диск.
...
2. Загружает один или несколько файлов экспорта (JSON). Бот подтверждает обработку каждого файла.
